...
public class EventIdentifierUtils {
    ...
    private static final Map<String, Pair<String, Operation>> REPLACEMENTS = ImmutableMap.<String, Pair<String, Operation>>builder()
            ...
            .put("COLOGNE", Pair.apply("KOLN", Operation.of(REPLACE)))
            .put("MGLADBACH", Pair.apply("MONCHENGLADBACH", Operation.of(REPLACE)))
            .put("SEKTZIA_NES_TZIONA", Pair.apply("SEKTZIA_NESS_ZIONA", Operation.of(REPLACE)))
            ...
            .put("_U", Pair.apply("_B", of(REPLACE_END_WITH)))
